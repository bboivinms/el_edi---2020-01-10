...
namespace vivael
{
    public partial class DataMenuOld : Form
    {
        public DataMenuOld()
        {
            InitializeComponent();
        ...
        //    {
        //        BtnFirst.State = Active;
        //        BtnPrev.State = Active;
        //        gNext(sdPTable);
        //    }
        //    else
        //    {
        //        BtnFirst.State = Grayed;
        //        BtnPrev.State = Grayed;
        //    }

        //    if (gNext(sdPTable))
        //    {
        //        BtnLast.State = Active;
        //        BtnNext.State = Active;
        //        gPrevious(sdPTable);
        //    }
        //    else
        //    {
        //        BtnLast.State = Grayed;
        //        BtnNext.State = Grayed;
        //    }

        //    // eof + bof = true if the respective states are Grayed
        //    eof = BtnLast.State == Grayed;
        //    bof = BtnFirst.State == Grayed;
        }
        ...
        public void FormMenu(string cType)
        {
            ...
            if (ALLTRIM(cType) == "P")
            {
                if (oSession.administrator)
                {
                    if (!EMPTY(cfunction))
                    {
                        //OpenSister(new wsm1permisold(), cfunction, Text, "");
                    }
                }
                else
                {
        ...
        public void SetQuery(string sLMyQuery)
        {
            bTableIsSet = true;

            gQuery(sLMyQuery, sdPTable);
