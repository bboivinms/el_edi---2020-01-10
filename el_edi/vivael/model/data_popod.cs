...
namespace vivael
{
	public class data_popod : DataSource
	{
		public data_popod() { Table_name = i.name = "popod"; i.primary_1 = "ident"; i.primary_2 = null; i.primary_3 = null; isFoxpro = true; }
		...
		private bool? _Livrer_Sur; public bool? Livrer_Sur { get { return _Livrer_Sur; } set { Set(ref _Livrer_Sur, value, "Livrer_Sur"); } }
		...
		private string _Magasine; public string Magasine { get { return _Magasine; } set { Set(ref _Magasine, value, "Magasine"); } }
		private bool? _Cheqterrm; public bool? Cheqterrm { get { return _Cheqterrm; } set { Set(ref _Cheqterrm, value, "Cheqterrm"); } }
		...
		private int? _Nogldep; public int? Nogldep { get { return _Nogldep; } set { Set(ref _Nogldep, value, "Nogldep"); } }
		...
		private string _Livrea; public string Livrea { get { return _Livrea; } set { Set(ref _Livrea, value, "Livrea"); } }
