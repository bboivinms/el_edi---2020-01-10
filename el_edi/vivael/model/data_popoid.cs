...
namespace vivael
{
	public class data_popoid : DataSource
	{
		public data_popoid() { Table_name = i.name = "popoid"; i.primary_1 = "ident"; i.primary_2 = null; i.primary_3 = null; isFoxpro = true; }
		...
		private long? _R_Qty_Ord; public long? R_Qty_Ord { get { return _R_Qty_Ord; } set { Set(ref _R_Qty_Ord, value, "R_Qty_Ord"); } }
		private decimal? _R_Cost; public decimal? R_Cost { get { return _R_Cost; } set { Set(ref _R_Cost, value, "R_Cost"); } }
