...
namespace vivael
{
	public class data_popoit : DataSource
	{
		public data_popoit() { Table_name = i.name = "popoit"; i.primary_1 = "idpo"; i.primary_2 = "line"; i.primary_3 = null; isFoxpro = true; }
		...
		private decimal? _Posurch; public decimal? Posurch { get { return _Posurch; } set { Set(ref _Posurch, value, "Posurch"); } }
