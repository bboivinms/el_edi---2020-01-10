...
namespace vivael
{
	public class data_popo : DataSource
	{
		public data_popo() { Table_name = i.name = "popo"; i.primary_1 = "ident"; i.primary_2 = null; i.primary_3 = null; isFoxpro = true; }
		...
		private bool? _Toute_Inventaire; public bool? Toute_Inventaire { get { return _Toute_Inventaire; } set { Set(ref _Toute_Inventaire, value, "Toute_Inventaire"); } }
		private bool? _Livrer_Sur_Recep; public bool? Livrer_Sur_Recep { get { return _Livrer_Sur_Recep; } set { Set(ref _Livrer_Sur_Recep, value, "Livrer_Sur_Recep"); } }
		...
		private bool? _Echantillon; public bool? Echantillon { get { return _Echantillon; } set { Set(ref _Echantillon, value, "Echantillon"); } }
		...
		private int? _Entrepot; public int? Entrepot { get { return _Entrepot; } set { Set(ref _Entrepot, value, "Entrepot"); } }
