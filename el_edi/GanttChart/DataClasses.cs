...
namespace vivael
{
    ...
    public class BarInformation
    {
        ...
        public BarInformation(int rowHeight, IDataRecord rowData, string rowText, string innerText, DateTime fromTime, DateTime totime, Color color, Color hoverColor, int index)
        {
            RowHeight = rowHeight;
            RowData = rowData;
            RowText = rowText;
